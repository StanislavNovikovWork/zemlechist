...
export function Suppliers() {
  const { openCreateSupplier, openViewSupplier } =
  ...
  const allSuppliers =
    markersData?.features?.map((feature: any) => ({
      id: feature.id,
            ...
            <Table
              ...
              onRow={(record) => ({
                onClick: () => {
                  ...
                  const originalFeature = markersData?.features?.find(
                    (f: any) => f.id === record.id
                  );
                  ...
                  const supplierData = {
                    ...
                    type:
                      originalFeature?.properties?.type || 'specialTechnique',
